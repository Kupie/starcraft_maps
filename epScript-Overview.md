# epScript — Big Picture Overview

> Conceptual background Claude should understand before writing any epScript.
> SC:R maps have NO scripting runtime — all epScript compiles down to trigger bytecode injected into the map.
